void particle_id_mega()
{
    ...
    TString outfileName( "Mega_output1.root" );
    ...
    TString inputFileName = "MegaBooNE.root";
    ...
    TMVA::DataLoader *dataloader = new TMVA::DataLoader("dataset_mega1");
    ...
    dataloader->PrepareTrainingAndTestTree(cuts, cutb, "nTrain_Signal=15750:nTrain_Background=44283:SplitMode=Random:!V" );
    ...
    if (useBDT)
    {
        factory.BookMethod(dataloader,TMVA::Types::kBDT, "BDT",
                           "!V:NTrees=500:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.2:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );
    }
    ...
    if (useMLP)
    {
        factory.BookMethod(dataloader, TMVA::Types::kMLP, "MLP",
                           "!H:!V:NeuronType=tanh:VarTransform=Norm:NCycles=500:HiddenLayers=N+5:TestRate=5:!UseRegulator" );
    }
