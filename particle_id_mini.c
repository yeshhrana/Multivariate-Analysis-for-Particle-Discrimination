void particle_id_mini()
{
    ...
    TString outfileName( "Mini_output.root" );
    ...
    TString inputFileName = "MiniBooNE.root";
    ...
    TMVA::DataLoader *dataloader = new TMVA::DataLoader("dataset_mini");
    ...
    dataloader->PrepareTrainingAndTestTree(cuts, cutb, "nTrain_Signal=17500:nTrain_Background=17500:nTest_Signal=2500:nTest_Background=2500:SplitMode=Random:!V" );
