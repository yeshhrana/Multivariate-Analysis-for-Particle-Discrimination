void particle_id_nano()
{
    ...
    TString outfileName( "Nano_output.root" );
    ...
    TString inputFileName = "NanoBooNE.root";
    ...
    TMVA::DataLoader *dataloader = new TMVA::DataLoader("dataset_nano");
    ...
    dataloader->PrepareTrainingAndTestTree(cuts, cutb, "SplitMode=Random:!V" );
